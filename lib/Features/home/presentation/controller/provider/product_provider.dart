...
class ProductProvider with ChangeNotifier {
  ...
  ProductModel? findProductId({required String proId}) {
    if (_products.where((element) => element.productId == proId).isEmpty) {
      return null;
    }
    return _products.firstWhere((element) => element.productId == proId);
  }
  ...
  List<ProductModel> getSearchResultList({
  ...
  // final List<ProductModel> _localProduct = [
  //   // // Phones
  //   // ProductModel(
  //   //   //1
